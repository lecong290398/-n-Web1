...
//tri
    ...
    //ham lay so dong du lieu
    $num_row = $obj_product->getNum_row();
    //tao bien thao tac voi nut tim kiem
    $products_search = NULL;
    
    //tao $page moi voi gia tri = 1 khi vua load trang
    $page = 1;
    $products_page = NULL;
    if(isset($_GET['p'])){
        $page = $_GET['p'];
        $products_page = $obj_product->getPage($page);
    }
    else{
        $products_page = $obj_product->getPage($page);
    }
    ...
    if (isset($_GET['search'])){
        $products_search = $obj_product->selectProduct($_GET['search']);
    }       
?>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<?php foreach ($products_page as $aaa): ?>
                                                <div class="product">
                                                    <div class="product_image"><img src="images/<?php echo $aaa['image']; ?>" alt=""></div>
                                                    <div class="product_extra product_sale"><a href="categories.php">Sale</a></div>
                                                    <div class="product_content">
                                                        <div class="product_title"><a href="product.php?id=<?php echo $aaa['ID']; ?>"><?php echo $aaa['name']; ?></a></div>
                                                        <div class="product_price"><?php echo $aaa['price']; ?> VNĐ</div>
                                                    </div>
						</div>
                                                <?php endforeach; ?>
                                            <?php  endif;?>
					    ...
					    <?php if (isset($_GET['search'])): ?>
                                                <?php foreach ($products_search as $aaa): ?>
                                                <div class="product">
                                                    <div class="product_image"><img src="images/<?php echo $aaa['image']; ?>" alt=""></div>
                                                    <div class="product_extra product_sale"><a href="categories.php">Sale</a></div>
                                                    <div class="product_content">
                                                        <div class="product_title"><a href="product.php"><?php echo $aaa['name']; ?></a></div>
                                                        <div class="product_price"><?php echo $aaa['price']; ?> VNĐ</div>
                                                    </div>
						</div>
                                                <?php endforeach; ?>
