...
if (isset($_GET['key'])) {
    $key = $_GET['key'];
    $mobiles = $obj_mobile->findMoblie($key);
    $manufature = $obj_mobile->getManufacture();
    $protype = $obj_mobile->getProtype();
} else {
    die('error');
}
?>
					...
					<div class="widget-content nopadding">
						...
						<form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								...
								<div class="controls">
                                                                    <input type="text"   class="span11" value="<?php echo $mobiles['name'] ;?>" name="name"  /> *
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="manu_id">
										<?php foreach ($manufature as $value):?>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea class="span11"  name = "description"><?php echo $mobiles['description'] ;?></textarea>
									</div>
									<div class="control-group">
										<label class="control-label">Price :</label>
										<div class="controls">
											<input type="text" class="span11" value="<?php echo $mobiles['price'] ;?>" name = "price" /> *
										</div>
									</div>
