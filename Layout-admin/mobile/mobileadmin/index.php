...
$total_rows = $mobile->count('products');
$per_page = 5;
if (isset($_GET['page'])) {
    $page = $_GET['page'];
} else {
...
$allproduct = $mobile->getAllProduct($page, $per_page);

$id = '';
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $mobile->deleteProducts($id);
}
// Login
$flag = 0;
...
<html lang="en">
    ...
    <body>
        ...
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav">
                <li  class="dropdown" id="profile-messages" ><a title="" href="index.php" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome Super Admin</span><b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="#"><i class="icon-user"></i> My Profile</a></li>
                        <li class="divider"></li>
                        <li><a href="#"><i class="icon-check"></i> My Tasks</a></li>
                                    ...
                                    <tbody>
                                        <?php foreach ($allproduct as $row) : ?>
                                            <tr class="">
                                                ...
                                                <td>
                                                    <a href="form-edit.php?id=<?php echo $row['ID'] ?>" class="btn btn-success btn-mini">Edit</a>
                                                    <a href="index.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger btn-mini">Delete</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
