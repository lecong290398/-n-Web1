...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
	<ul>
            ...
            <li> <a href="protype.php"><i class="icon icon-th-list"></i> <span>Product Type</span></a></li>
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tr class="">
								...
								<td>
                                                                    <a href="form.php?key=<?php echo $value['ID']; ?>" class="btn btn-success btn-mini">Edit</a>
                                                                    <a href="index.php?id=<?php echo $value['ID']; ?>" class="btn btn-danger btn-mini">Delete</a>
								</td>
