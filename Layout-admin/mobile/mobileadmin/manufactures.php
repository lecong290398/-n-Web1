...
$manufactures = $mobile->getAllManufactures();
?>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($manufactures as $manu) : ?>
                                            <tr class="">
                                                <td><?php echo $manu['Manu_ID']; ?></td>
                                                <td><?php echo $manu['Manu_name']; ?></td>
                                                <td><img src="../public/images/<?php echo $manu['Manu_image']; ?>" style="width:140px;"></td>
                                                <td>
